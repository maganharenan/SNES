...
;                             * INIT HARDWARE *                            ;
; ==========================================================================
; The InitHardware macro is a comprehensive initialization routine for the 
; 65816 processor. It sets up the processor state, including interrupt 
; handling, arithmetic flags, processor mode, and stack pointer, before 
; jumping to a routine for further initialization. This ensures that the 
; system starts in a known, consistent state, ready for the main application 
; code to execute.
; ==========================================================================
;                                 * USAGE *                                ;
; ==========================================================================
; To use this macro in your assembly code, you would simply include it 
; at the beginning of your program, like so: `InitHardware`
; ==========================================================================

.MACRO InitHardware
    SEI         ; Set interrupt disable flags
    CLC         ; Clear carry
    XCE         ; Exchange carry and Emutalion flags

    REP #$38    ; A, X and Y are now 16-bit, decimal mode off

    LDX #$1FFF  ; Setup the stack
    TXS         ; Transfer to stack pointer

    JSL $008000 ; Handle the rest of initialization in a routine 

    SEP #$20    ; Switch back to 8-bit A
.ENDM
