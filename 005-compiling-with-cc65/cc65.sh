...
# 65816 assembly code using the cc65 toolchain. It takes the name of an
...
# run the script like this: `./cc65.sh program`
# If the permission denied error happens, just use: `chmod +x cc65.sh`
# ==========================================================================


ca65 --cpu 65816 -o $1.o $1.s
