...
.proc   ResetHandler
        ...
        lda #$C0                ; push number of bytes (192/$80) to transfer to stack
        pha
...
UpdateOtherSprites:
        ...
        sta OAMMIRROR + $10     ; update sprite 5
        clc
        adc #SPRITE_SIZE
        sta OAMMIRROR + $04     ; update sprite 2
        sta OAMMIRROR + $0c     ; update sprite 4
        sta OAMMIRROR + $14      ; update sprite 6
        ; vertical position
        ...
        adc #SPRITE_SIZE
        sta OAMMIRROR + $11      ; update sprite 5
        sta OAMMIRROR + $15      ; udpate sprite 6
